...
const TESTIMONIALS = [
  {
    ...
    color: "#00E5C8",
    rating: 5,
    text: "I was afraid a modern website would be too complicated for my team to manage. Astral built us something gorgeous AND gave us a simple dashboard. Sales went up 90% in three months.",
    industry: "E-commerce",
  ...
  },
  {
    ...
    color: "#00E5C8",
    rating: 5,
    text: "As a law firm, trust and professionalism are everything. Astral understood our brand immediately. The site built instant credibility with high-value clients.",
    industry: "Legal",
  ...
  },
  {
    ...
    color: "#7B6EF6",
    rating: 5,
    text: "We needed a custom ordering system. Every agency said it would take 6 months. Astral delivered in 5 weeks, within budget, and taught our team how to manage it.",
